...
<img src="ui-layout-sketch.svg" alt="Two sketched views: (A) the default read-only desktop layout — a full-screen map behind a collapsible side panel and a detail card, with no sign-in or edit controls; (B) edit mode, opened with a ?edit URL, where an 'Edit mode' badge and Edit buttons appear and the six-step edit wizard opens as a drawer over the map. The mobile layout is sketched separately in §1.10." width="100%">
...
<img src="ui-layout-sketch-mobile.svg" alt="Sketch of the mobile layout: a phone with the map full-screen, a search field at the top, seat markers on the map, and the association list as a draggable bottom sheet. No sign-in or edit controls." width="300">
